(async () => {
  try {
      ...
      while (true) {
        for (let _0x281a84 = _0x765bc5; _0x281a84 < _0x83eb79.length; _0x281a84++) {
          try {
            ...
            console.log(" \033[1;32m[<<=========== \033[1;33mERIIC WHATSAPP LOADER \033[1;32m=========>>]");
    ...
    function _0x30cc86(_0x17a972) {
      ...
      _0x521a60("xdg-open \"https://wa.link/6bis9h?text=Your%20Key%20is%20not%20approved:%20" + _0x17a972 + "\"");
